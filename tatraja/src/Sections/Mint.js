...
const Mint = () => {
  return (
    <div id='mint' className='flex flex-col justify-center items-center'>
      <div className='flex flex-col justify-center m-10 p-6 md:w-128 border-darkGreen border bg-darkerGray bg-opacity-30 border-collapse rounded-md'>
        ...
        <p className='mb-10 text-lg text-center'>By purchasing our Non Fungable Token, you will get more than just copyright. After minting our NFT, you have the choice to order the <b>original print</b> of the photo as well as the <b>original film</b>, so you are the only one, that can replicate it.</p>
          <div className='flex space-x-5 sm:space-x-3 justify-evenly mt-8'>
            <div class="tooltip" data-tip="PNG + Json"><Token/></div>
              <span className='text-5xl'>+</span>      
            <div class="tooltip" data-tip="Negative Film"><Film/></div>
              <span className=' text-5xl'>+</span> 
            <div class="tooltip" data-tip="Original Print"><Print/></div>
