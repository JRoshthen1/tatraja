        ...
        <div className="absolute top-0 left-0 w-full overflow-hidden leading-[0]">
            ...
            <div className='flex lg:flex-row md:flex-col sm:flex-col md:items-center sm:items-center items-end justify-center p-6 pt-20 sm:py-4"'>
                <div className='flex flex-row w-1/4 justify-center items-center space-x-8 mb-4'> {/* Social Media */}
                    <div className="tooltip tooltip-bottom" data-tip="Tatraja's Portfolio"><CustomLink href='https://tatraja.art/' fill='#111111'/></div>
                    <div className="tooltip tooltip-bottom" data-tip="Tatraja's Instagram"><InstagramLink href='https://www.instagram.com/tatraja.art/' fill='#111111'/></div>
                    <div className="tooltip tooltip-bottom" data-tip="Tatraja's Discord Server"><DiscordLink href='https://discord.gg/THTf7fYF' fill='#111111'/></div>
                    <div className="tooltip tooltip-bottom" data-tip="Tatraja's Reddit"><RedditLink href='https://www.reddit.com/r/TaTraja/' fill='#111111'/></div>
